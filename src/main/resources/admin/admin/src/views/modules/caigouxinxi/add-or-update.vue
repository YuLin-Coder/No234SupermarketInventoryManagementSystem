<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="供应商名称" prop="gongyingshangmingcheng">
          <el-select :disabled="ro.gongyingshangmingcheng" v-model="ruleForm.gongyingshangmingcheng" placeholder="请选择供应商名称">
            <el-option
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.caigoubeizhu" label="采购备注" prop="caigoubeizhu">
                    <span>{{ruleForm.caigoubeizhu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
		...
		if(json.yuangongxingming!=''&&json.yuangongxingming){
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                this.gongyingshangmingchengOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `caigouxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.caigouxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
