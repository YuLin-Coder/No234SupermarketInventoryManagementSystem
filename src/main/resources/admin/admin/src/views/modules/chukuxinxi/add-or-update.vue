<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="承运商名称" prop="chengyunshangmingcheng">
          <el-select :disabled="ro.chengyunshangmingcheng" v-model="ruleForm.chengyunshangmingcheng" placeholder="请选择承运商名称">
            <el-option
