<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="承运商编号" prop="chengyunshangbianhao">
            <el-input v-model="ruleForm.chengyunshangbianhao" 
                placeholder="承运商编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chengyunshangbianhao" label="承运商编号" prop="chengyunshangbianhao">
              <el-input v-model="ruleForm.chengyunshangbianhao" 
                placeholder="承运商编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="承运商名称" prop="chengyunshangmingcheng">
          <el-input v-model="ruleForm.chengyunshangmingcheng" 
              placeholder="承运商名称" clearable  :readonly="ro.chengyunshangmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="承运商名称" prop="chengyunshangmingcheng">
              <el-input v-model="ruleForm.chengyunshangmingcheng" 
                placeholder="承运商名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="承运商电话" prop="chengyunshangdianhua">
          <el-input v-model="ruleForm.chengyunshangdianhua" 
              placeholder="承运商电话" clearable  :readonly="ro.chengyunshangdianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="承运商电话" prop="chengyunshangdianhua">
              <el-input v-model="ruleForm.chengyunshangdianhua" 
                placeholder="承运商电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="承应商地址" prop="chengyingshangdizhi">
          <el-input v-model="ruleForm.chengyingshangdizhi" 
              placeholder="承应商地址" clearable  :readonly="ro.chengyingshangdizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="承应商地址" prop="chengyingshangdizhi">
              <el-input v-model="ruleForm.chengyingshangdizhi" 
                placeholder="承应商地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	chengyunshangbianhao : false,
	chengyunshangmingcheng : false,
	chengyunshangdianhua : false,
	fuzeren : false,
	chengyingshangdizhi : false,
      },
      ruleForm: {
        chengyunshangbianhao: this.getUUID(),
        chengyunshangmingcheng: '',
        chengyunshangdianhua: '',
        fuzeren: '',
        chengyingshangdizhi: '',
      },
      rules: {
          chengyunshangbianhao: [
          ],
          chengyunshangmingcheng: [
          ],
          chengyunshangdianhua: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='chengyunshangbianhao'){
            this.ruleForm.chengyunshangbianhao = obj[o];
	    this.ro.chengyunshangbianhao = true;
            continue;
          }
          if(o=='chengyunshangmingcheng'){
            this.ruleForm.chengyunshangmingcheng = obj[o];
	    this.ro.chengyunshangmingcheng = true;
            continue;
          }
          if(o=='chengyunshangdianhua'){
            this.ruleForm.chengyunshangdianhua = obj[o];
	    this.ro.chengyunshangdianhua = true;
            continue;
          }
          if(o=='fuzeren'){
	    ...
	    this.ro.fuzeren = true;
          ...
          if(o=='chengyingshangdizhi'){
            this.ruleForm.chengyingshangdizhi = obj[o];
	    this.ro.chengyingshangdizhi = true;
            continue;
          }
        }
      }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `chengyunshang/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.chengyunshangCrossAddOrUpdateFlag = false;
						 this.parent.search();
