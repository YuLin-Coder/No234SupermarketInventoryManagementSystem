<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="仓库号" prop="cangkuhao">
          <el-input v-model="ruleForm.cangkuhao" 
              placeholder="仓库号" clearable  :readonly="ro.cangkuhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="仓库号" prop="cangkuhao">
              <el-input v-model="ruleForm.cangkuhao" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="仓库详情" prop="cangkuxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.cangkuxiangqing" label="仓库详情" prop="cangkuxiangqing">
                    <span v-html="ruleForm.cangkuxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.cangkuleixingOptions = "大,中,小".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.cangkuxiangqing = this.ruleForm.cangkuxiangqing.replace(reg,'../../../springboots5264/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
