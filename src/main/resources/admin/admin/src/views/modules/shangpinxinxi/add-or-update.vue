<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="仓库号" prop="cangkuhao">
          <el-select :disabled="ro.cangkuhao" @change="cangkuhaoChange" v-model="ruleForm.cangkuhao" placeholder="请选择仓库号">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.cangkuhao" label="仓库号" prop="cangkuhao">
...
export default {
  ...
  methods: {
    ...
    cangkuhaoChange () {
      this.$http({
        url: `follow/cangkuxinxi/cangkuhao?columnValue=`+ this.ruleForm.cangkuhao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../springboots5264/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
