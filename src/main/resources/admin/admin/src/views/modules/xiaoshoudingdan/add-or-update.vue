<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="订单总价" prop="dingdanzongjia">
            <el-input v-model="dingdanzongjia"
                placeholder="订单总价" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.dingdanzongjia" label="订单总价" prop="dingdanzongjia">
              <el-input v-model="ruleForm.dingdanzongjia" 
                placeholder="订单总价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
...
export default {
  ...
  computed: {
    ...
    dingdanzongjia:{
      get: function () {
        return 1*this.ruleForm.jiage*this.ruleForm.dingdanshuliang
      }
    },
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dingdanshuliang = true;
          ...
          if(o=='dingdanzongjia'){
            this.ruleForm.dingdanzongjia = obj[o];
	    this.ro.dingdanzongjia = true;
            continue;
          }
          if(o=='dingdanshijian'){
	...
	this.ruleForm.dingdanxiangqing = this.ruleForm.dingdanxiangqing.replace(reg,'../../../springboots5264/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    // 提交
    onSubmit() {
        this.ruleForm.dingdanzongjia = this.dingdanzongjia
