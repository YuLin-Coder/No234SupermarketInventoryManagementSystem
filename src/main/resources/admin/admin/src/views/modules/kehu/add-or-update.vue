<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.kehutouxiang" label="客户头像" prop="kehutouxiang">
          <file-upload
          tip="点击上传客户头像"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.kehutouxiang?ruleForm.kehutouxiang:''"
          @change="kehutouxiangUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.kehutouxiang" label="客户头像" prop="kehutouxiang">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.kehutouxiang.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kehuxingming = true;
          ...
          if(o=='kehutouxiang'){
            this.ruleForm.kehutouxiang = obj[o];
	    this.ro.kehutouxiang = true;
            continue;
          }
          if(o=='kehudianhua'){
	...
	if(this.ruleForm.kehutouxiang!=null) {
		this.ruleForm.kehutouxiang = this.ruleForm.kehutouxiang.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
	...
	this.ruleForm.kehutouxiang = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
