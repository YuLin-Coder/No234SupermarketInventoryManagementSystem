<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="岗位人数" prop="gangweirenshu">
          <el-input v-model="ruleForm.gangweirenshu" 
              placeholder="岗位人数" clearable  :readonly="ro.gangweirenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="岗位人数" prop="gangweirenshu">
              <el-input v-model="ruleForm.gangweirenshu" 
                placeholder="岗位人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="岗位简介" prop="gangweijianjie">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.gangweijianjie" label="岗位简介" prop="gangweijianjie">
                    <span>{{ruleForm.gangweijianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gangwei = true;
          ...
          if(o=='gangweirenshu'){
            this.ruleForm.gangweirenshu = obj[o];
	    this.ro.gangweirenshu = true;
            continue;
          }
          if(o=='gangweijianjie'){
