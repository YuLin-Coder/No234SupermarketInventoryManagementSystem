    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="部门简介" prop="bumenjianjie">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="部门简介"
                  v-model="ruleForm.bumenjianjie" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.bumenjianjie" label="部门简介" prop="bumenjianjie">
                    <span>{{ruleForm.bumenjianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.bumen = true;
          ...
          if(o=='bumenjianjie'){
            this.ruleForm.bumenjianjie = obj[o];
	    this.ro.bumenjianjie = true;
            continue;
          }
        }
      }
